...
Es wird die Benutzerkennung des :doc:`Paketadmins<../benutzer/paket-admin>` beim Benutzernamen und unter Passwort das entsprechende Passwort eingetragen.
...
Da die :doc:`Domain<../domain/index>` aus Sicherheitsgünden nur einem :doc:`Benutzer<../benutzer/index>` innerhalb einer Benutzerkennung zugeordnet werden soll, legen wir als nächstes einen neuen Benutzer in userem Paket xyz00 an.
...
Damit kommen wir nun zur eigentlichen Aufgabe, eine :doc:`Domain<../domain/index>` anzulegen.
...
Bei Domain den neuen Domainnamen und als Adminstrator den :doc:`Domain-Admin<verzeichnisebenen-domain-admin>` xyz00-doms eintragen.
